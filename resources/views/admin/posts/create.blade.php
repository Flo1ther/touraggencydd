...
@section('content')
    <div class="max-w-4xl mx-auto py-10 px-6">
        <div class="mb-6 flex justify-between items-center">
            ...
            <h1 class="text-2xl font-bold text-blue-700">Створити пост</h1>
        </div>
        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="content" rows="6" class="w-full border rounded px-3 py-2" required>{{ old('content') }}</textarea>
            </div>

            <div>
                <label class="block text-gray-700 font-medium">Зображення</label>
                <input type="file" name="image" class="w-full border rounded px-3 py-2">
                <p class="text-xs text-gray-500 mt-1">Опційно. Підтримуються JPG, PNG, WEBP.</p>
            </div>
